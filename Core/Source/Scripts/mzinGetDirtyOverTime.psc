...
Event OnBiS_CleanActorDirt(Float TimeToClean, Float TimeToCleanInterval, Bool UsedSoap)
...
Function RegisterForEvents()
	...
	RegisterForModEvent("BiS_CleanActorDirt_" + DirtyActor.GetFormID(), "OnBiS_CleanActorDirt")
